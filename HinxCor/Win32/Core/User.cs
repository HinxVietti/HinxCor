...
using POINT = System.Drawing.Point;//added
using RECT = System.Drawing.Rectangle;//added
using DEVMODE = HinxCor.Win32.DEVMODEW;//added
...
#pragma warning disable
    ...
    public class User32
    {
        ...
        [DllImport("user32")] public static extern IntPtr GetDC(HWND hwnd);
        ...
        [DllImport("user32.dll", SetLastError = true)] public static extern IntPtr GetParent(HWND hwnd);
        ...
        [DllImport("user32")] public static extern int GetWindowThreadProcessId(HWND hwnd, ref uint lpdwProcessId);
        ...
        [DllImport("user32", CharSet = CharSet.Auto)] public static extern int MessageBox(HWND hwnd, string lpText, string lpCaption, int wType);
        ...
        [DllImport("user32", CharSet = CharSet.Auto)] public static extern int MoveWindow(HWND hwnd, int x, int y, int nWidth, int nHeight, int bRepaint);
